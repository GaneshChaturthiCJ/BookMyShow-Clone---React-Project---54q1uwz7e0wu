...
const Navigation = () => {
  ...
  }, [searchTerm,url]); // Only re-run the effect if the search term changes
  ...
  return (
    ...
    <nav className="navBar">
        <a href="/"><img src={bookMyShowLogo} alt='bookMyShowLogo' width="80px"  height="130px" /></a>
        ...
        <div className='userContainer'>
            ...
            <h5>{(loggedInUserName === "" ? "🤔": loggedInUserName.toUpperCase())}</h5>
        </div>
