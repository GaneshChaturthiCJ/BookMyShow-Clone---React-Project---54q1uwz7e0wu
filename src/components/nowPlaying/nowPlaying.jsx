...
import { MyModalContext, searchMoviesContext, wishListContext } from '../../App';
...
//to store movie each time modal is clicked




const NowPlaying = ( {movieList, setMovieList, movieListBackup, setMovieListBackup, selectedGenreItem, setSelectedGenreItem } ) => {
...
//functions to open and close modal
  ...
  const handleMovieCardClick = (event) => {
    ...
    const handleAddWishList = (event) => {
        ...
        const divDataForWishlist = {
            ...
            imageUrl: event.target.parentElement.querySelector('img').getAttribute('src'),
            movieDescription: event.target.parentElement.querySelectorAll('div')[1].textContent,
            ...
            movieId: event.target.parentElement.querySelectorAll('span')[0].textContent,
            releaseDate: event.target.parentElement.querySelectorAll('span')[1].textContent,
        };
      
       console.log(divDataForWishlist);

       setWishList([...wishList,divDataForWishlist]); // added item ti wishlist state variable
      };
  ...
  return (
    <>
    <Navigation />
    <Genre movieList={movieList} selectedGenreItem={selectedGenreItem} setSelectedGenreItem={setSelectedGenreItem} />
    ...
    <Modal
      ...
      >
        ...
        <div className="modalImage"><img src={modalData.imageUrl} width="250px" height="190px" alt="ImgFailed" /></div>
        ...
        <Button onClick={ () => { navigate("seat-booking") }} >Book Tickets</Button>
