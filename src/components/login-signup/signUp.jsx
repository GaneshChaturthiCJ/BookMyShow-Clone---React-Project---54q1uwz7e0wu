...
export function UserSignUpForm( { loginOrSignUp,setLoginOrSignUp } ) {
    ...
    <div className="wraper-div">
      ...
      <form onSubmit={submitHandler} className="login-form">
        ...
        <div className="login-logo">
          <BsShieldLock style={{ fontSize: "3rem" }} />
        </div>
        ...
        <input
          ...
          value={email}
        />
        {emailFlag && <div className="warning">Please Enter User email</div>}
        ...
        <input
          ...
          value={password}
        />
        {passwordFlag && <div className="warning">Please Enter User password</div>}
